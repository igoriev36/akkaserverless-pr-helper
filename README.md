...
```
> curl -XPOST -H "Content-Type: application/json" localhost:9000/net.bzzt.MyServiceEntity/GetValue -d '{"entityId": "foo"}'
...
```
> grpcurl -plaintext -d '{"entityId": "foo"}' localhost:9000 net.bzzt.MyServiceEntity/GetValue
ERROR:
  Code: Unknown
